...
| Layer | Technologies |
|-------|-------------|
| **Frontend** | C# · Windows Forms · DataGridViews · ComboBoxes · TabControl · PictureBox |
| **Backend** | SQL Server · ADO.NET · Repository Pattern |
| **Architecture** | Transações, layered design |
